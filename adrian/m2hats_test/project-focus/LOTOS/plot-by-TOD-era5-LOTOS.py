...
site_alt  = 1500.0  # LOTOS2025 ISS2 site elevation (m MSL) - REPLACE (read from VAD 'alt' var)
...
fig.suptitle('Mean Difference by Hour of Day (VAD - ERA5), LOTOS2025', fontsize=16)
